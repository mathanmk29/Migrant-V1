          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 xl:gap-16 items-center max-w-[1200px] mx-auto">
            ...
            <div className="space-y-8 w-full max-w-2xl md:max-w-3xl lg:max-w-4xl ml-4 md:ml-0">
              ...
              <p className="text-lg sm:text-xl text-blue-700 font-medium leading-relaxed">
                A digital platform to support migrants by simplifying grievance
                reporting and ensuring timely resolution — in collaboration with
                agencies and government bodies.
              </p>
              <Link
                to="/signup/migrant"
                className="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-blue-700 transition-all hover:shadow-lg hover:scale-105 group"
              >
                Get Started
                <span className="ml-2 transition-transform group-hover:translate-x-1 text-xl">
                  →
                </span>
              </Link>
            </div>
