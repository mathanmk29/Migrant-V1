            ...
            <AnimatePresence>
              {agencies.map((agency) => (
                <motion.li
                  ...
                  onClick={() =>
                    setExpandedAgency(
                      expandedAgency === agency._id ? null : agency._id
                    )
                  }
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div className="mb-5 md:mb-0 flex items-start space-x-5">
                      ...
                      <div>
                        ...
                        <AnimatePresence>
                          // In AgencySection.jsx - Update the expanded section
                          with this code:
                          {expandedAgency === agency._id && (
                            <motion.div
                              ...
                              className="mt-4 p-4 bg-gray-50 rounded-lg space-y-3 text-sm"
                            >
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex items-start">
                                    <FiPhone className="mr-2 mt-0.5 flex-shrink-0 text-gray-400" />
                                    <div>
                                      <p className="text-xs text-gray-500">
                                        Phone
                                      </p>
                                  ...
                                  <div className="flex items-start">
                                    <FiBriefcase className="mr-2 mt-0.5 flex-shrink-0 text-gray-400" />
                                    <div>
                                      <p className="text-xs text-gray-500">
                                        Department
                                      </p>
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-start">
                                    <FiKey className="mr-2 mt-0.5 flex-shrink-0 text-gray-400" />
                                    <div>
                                      <p className="text-xs text-gray-500">
                                        License Number
                                      </p>
                                      <p className="text-gray-700 font-mono">
                                        {agency.licenseNumber || "Not provided"}
                                      </p>
                                    </div>
                                  </div>

                                  <div className="flex items-start">
                                    <FiCalendar className="mr-2 mt-0.5 flex-shrink-0 text-gray-400" />
                                    <div>
                                      <p className="text-xs text-gray-500">
                                        Registration Date
                                      </p>
                                  ...
                                  <div className="flex items-start">
                                    <div className="mr-2 mt-0.5 flex-shrink-0 text-gray-400">
                                      {agency.isVerified ? (
